...
const BaseStats = ({ pokemon }: Props) => {
  return (
    <>
      <Title
        bold
        color={POKEMON_TYPE_COLORS[pokemon.types[0].type.name.toLowerCase() as keyof typeof POKEMON_TYPE_COLORS]}
      >
        Estatísticas
      </Title>
          ...
          <StatGraph>
            ...
            <StatLine>
              <StatValue
                ...
                backgroundColor={
                  POKEMON_TYPE_COLORS[pokemon.types[0].type.name.toLowerCase() as keyof typeof POKEMON_TYPE_COLORS]
                }
              />
            </StatLine>
          </StatGraph>
